...
/** Calls RMIT VAL's Chat Completions API and normalizes the response for AI Canva. */
export async function generateValContent(
  ...
  if (!apiKey) {
    throw new AIProviderError(
      503,
      "RMIT VAL is not configured. Set VAL_API_KEY and AI_PROVIDER=val in functions/.env.",
    );
  }
